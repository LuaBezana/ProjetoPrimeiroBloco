...
public class TesteProjeto {
	...
	public static void main(String[] args) {
		...
		while (continuar == 1) {
			...
			switch (opcao) { //lista recebe opção escolhida
			case 1:
				lista = filmes;
				break;
			case 2:
			...
			if (lista != null) { //entra apenas se a lista tiver opção válida
				lista.listaGeneros();
				int genero = scanner.nextInt();
				switch (genero) {
				case 1:
					System.out.println("\nSugestões:\n" + lista.lista1()); //sugestões
					break;
				case 2:
					System.out.println("\nSugestões:\n" + lista.lista2());
					break;
			...
			while (continuar != 0 && continuar != 1) { //illegalArgumentExc se usuário digitar errado
				try {
					...
					+ "\n0- Não."
					+ "\n1- Sim! Me mostre as opções!");
					continuar = scanner.nextInt(); //informar opção válida
				}
			}
		}
